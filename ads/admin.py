...
class AdAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        return (
            ...
            .annotate(image_count_annotated=Count("images"))
        )
...
class TemporaryAdAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("product_name", "description", "price", "category")}),
        (
            "Session Information",
            {
                "fields": ("created_at", "updated_at"),
    ...
    def delete_old_drafts(self, request, queryset):
        ...
        old_drafts = queryset.filter(created_at__lt=timezone.now() - timedelta(days=7))
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    list_display = ("name", "slug", "description_short", "ad_count", "created_at")
...
class CustomerProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ("user_mobile", "created_at", "updated_at")
