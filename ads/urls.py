...
temp_ads_router = NestedSimpleRouter(
    router, r"guest/temporary-ads", lookup="temporary_ad"
)
temp_ads_router.register(
    r"images", TemporaryAdImageViewSet, basename="temporary-ad-image"
)
